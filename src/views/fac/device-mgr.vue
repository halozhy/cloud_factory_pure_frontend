<template>
  <div class="app-container">
    <div class="filter-container" style="margin-bottom: 1rem">
      ...
      <el-button class="filter-item" style="float:right" type="" icon="el-icon-plus" @click="handleListRent">
        租用
      </el-button>
    ...
    <el-dialog title="租用" :visible.sync="dialogRentFormVisible" class="pub_dialog" top="0">
      ...
      <el-dialog title="确认租用" :visible.sync="dialogConfirmRentFormVisible" append-to-body>
        <el-form ref="dataForm" :rules="rentrules" :model="rentConfirm" label-position="left">
          <el-form-item label="选择到期时间" prop="expireTime">
            <el-date-picker
              v-model="expireTime"
              type="datetime"
              placeholder=""
...
export default {
  ...
  data() {
    var checkRentTime = (rule, value, callback) => {
      if (!this.expireTime) {
    ...
    return {
      ...
      rentrules: {
        expireTime: [
          { validator: checkRentTime, trigger: 'blur' }
        ]
      }
    }
  },
