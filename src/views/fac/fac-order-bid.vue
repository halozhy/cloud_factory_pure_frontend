<template>
  <div class="app-container">
    ...
    <el-dialog title="竞标" :visible.sync="dialogBidFormVisible">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" type="primary" @click="bid()">
          确认竞标
        </el-button>
        <el-button size="mini" type="" @click="dialogBidFormVisible = false">关闭</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    handleBid(row) {
      ...
      this.dialogBidFormVisible = true
    },
    bid() {
      var info = {
        'user_id': this.user_id,
